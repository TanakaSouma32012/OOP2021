...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: このコード行はデータを 'infosys202102DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202102DataSet.Person);

        }

        private void btNameFilter_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202102DataSet.Person, tbNameSearch.Text);
        }
        ...
        {
            this.personTableAdapter.FillByBirthday(this.infosys202102DataSet.Person, dtpBirthdaySearch.Text);
        }
    }
}
